...
export const metadata: Metadata = {
  title: "Cursos SEPE Barcelona - Formación Profesional Gratuita 2024",
  description: "Cursos gratuitos del SEPE en Barcelona: informática, marketing digital, sanidad, idiomas y más. Formación profesional con certificación oficial en Cataluña.",
  keywords: ["cursos inem barcelona", "cursos sepe barcelona", "formación profesional barcelona", "cursos gratuitos cataluña", "cursos sepe cataluña"],
  alternates: {
    canonical: "/cursos-ccaa/barcelona",
  },
};
...
export default function CursosBarcelonaPage() {
  return (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-blue-100">
                Formación profesional gratuita con certificación oficial en Barcelona y toda Cataluña. Más de 45 cursos disponibles.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="flex-1">
                <div className="max-w-4xl mx-auto mb-10">
                  <p className="text-lg text-gray-700 mb-6">
                    Barcelona ofrece una amplia variedad de cursos de formación profesional gratuitos del SEPE. 
                    Los cursos están adaptados a las necesidades del mercado laboral catalán y cuentan con certificación oficial.
                  </p>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-blue-900 mb-2">Cómo inscribirse en Barcelona</h3>
                    <p className="text-blue-800 leading-relaxed">
                      Puedes inscribirte online a través de la sede electrónica del SEPE o presencialmente en la oficina de Barcelona. 
