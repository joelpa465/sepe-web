...
export const metadata: Metadata = {
  title: "Cursos SEPE Bilbao - Formación Profesional Gratuita 2024",
  description: "Cursos gratuitos del SEPE en Bilbao: informática, marketing digital, sanidad, idiomas y más. Formación profesional con certificación oficial en el País Vasco.",
  keywords: ["cursos inem bilbao", "cursos sepe bilbao", "formación profesional bilbao", "cursos gratuitos país vasco", "cursos sepe euskadi"],
  alternates: {
    canonical: "/cursos-ccaa/bilbao",
  },
};
...
export default function CursosBilbaoPage() {
  return (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-blue-100">
                Formación profesional gratuita con certificación oficial en Bilbao y todo el País Vasco. Más de 24 cursos disponibles.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-700">Bilbao</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div className="flex-1">
                <div className="max-w-4xl mx-auto mb-10">
                  <p className="text-lg text-gray-700 mb-6">
                    Bilbao ofrece una amplia variedad de cursos de formación profesional gratuitos del SEPE. 
                    Los cursos están adaptados a las necesidades del mercado laboral vasco y cuentan con certificación oficial.
                  </p>
                  <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg">
                    <p className="text-blue-800">
                      <strong>Oficina SEPE Bilbao:</strong> C/ Alameda de Urquijo, 36, 48008 Bilbao. Teléfono: 901 11 99 99
                    </p>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-blue-900 mb-2">Cómo inscribirse en Bilbao</h3>
                    <p className="text-blue-800 leading-relaxed">
                      Puedes inscribirte online a través de la sede electrónica del SEPE o presencialmente en la oficina de Bilbao. 
