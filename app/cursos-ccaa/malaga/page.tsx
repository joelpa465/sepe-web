...
export const metadata: Metadata = {
  title: "Cursos SEPE Málaga - Formación Profesional Gratuita 2024",
  description: "Cursos gratuitos del SEPE en Málaga: informática, marketing digital, sanidad, idiomas y más. Formación profesional con certificación oficial en Andalucía.",
  keywords: ["cursos inem malaga", "cursos sepe malaga", "formación profesional malaga", "cursos gratuitos andalucía", "cursos sepe andalucía"],
  alternates: {
    canonical: "/cursos-ccaa/malaga",
  },
};
...
export default function CursosMalagaPage() {
  return (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-blue-100">
                Formación profesional gratuita con certificación oficial en Málaga y toda Andalucía. Más de 32 cursos disponibles.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-700">Málaga</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div className="flex-1">
                <div className="max-w-4xl mx-auto mb-10">
                  <p className="text-lg text-gray-700 mb-6">
                    Málaga ofrece una amplia variedad de cursos de formación profesional gratuitos del SEPE. 
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg">
                    <p className="text-blue-800">
                      <strong>Oficina SEPE Málaga:</strong> Av. de la Aurora, s/n, 29006 Málaga. Teléfono: 901 11 99 99
                    </p>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-blue-900 mb-2">Cómo inscribirse en Málaga</h3>
                    <p className="text-blue-800 leading-relaxed">
                      Puedes inscribirte online a través de la sede electrónica del SEPE o presencialmente en la oficina de Málaga. 
