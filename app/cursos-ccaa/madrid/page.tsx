...
export const metadata: Metadata = {
  title: "Cursos SEPE Madrid - Formación Profesional Gratuita 2024",
  description: "Cursos gratuitos del SEPE en Madrid: informática, marketing digital, sanidad, idiomas y más. Formación profesional con certificación oficial en la Comunidad de Madrid.",
  keywords: ["cursos inem madrid", "cursos sepe madrid", "formación profesional madrid", "cursos gratuitos madrid", "cursos sepe comunidad madrid"],
  alternates: {
    canonical: "/cursos-ccaa/madrid",
  },
};
...
export default function CursosMadridPage() {
  return (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-blue-100">
                Formación profesional gratuita con certificación oficial en Madrid y toda la Comunidad de Madrid. Más de 52 cursos disponibles.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="flex-1">
                <div className="max-w-4xl mx-auto mb-10">
                  <p className="text-lg text-gray-700 mb-6">
                    Madrid ofrece una de las mayores ofertas de cursos de formación profesional gratuitos del SEPE. 
                    Los cursos están adaptados a las necesidades del mercado laboral madrileño y cuentan con certificación oficial.
                  </p>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-blue-900 mb-2">Cómo inscribirse en Madrid</h3>
                    <p className="text-blue-800 leading-relaxed">
                      Puedes inscribirte online a través de la sede electrónica del SEPE o presencialmente en la oficina de Madrid. 
