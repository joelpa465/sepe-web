...
export const metadata: Metadata = {
  title: "Cursos SEPE Valencia - Formación Profesional Gratuita 2024",
  description: "Cursos gratuitos del SEPE en Valencia: informática, marketing digital, sanidad, idiomas y más. Formación profesional con certificación oficial en la Comunidad Valenciana.",
  keywords: ["cursos inem valencia", "cursos sepe valencia", "formación profesional valencia", "cursos gratuitos valencia", "cursos sepe comunidad valenciana"],
  alternates: {
    canonical: "/cursos-ccaa/valencia",
  },
};
...
export default function CursosValenciaPage() {
  return (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold mb-4">
                Cursos SEPE Valencia
              </h1>
              <p className="text-xl text-blue-100">
                Formación profesional gratuita con certificación oficial en Valencia y toda la Comunidad Valenciana. Más de 28 cursos disponibles.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-700">Valencia</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div className="flex-1">
                <div className="max-w-4xl mx-auto mb-10">
                  <p className="text-lg text-gray-700 mb-6">
                    Valencia ofrece una amplia variedad de cursos de formación profesional gratuitos del SEPE. 
                    Los cursos están adaptados a las necesidades del mercado laboral valenciano y cuentan con certificación oficial.
                  </p>
                  <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg">
                    <p className="text-blue-800">
                      <strong>Oficina SEPE Valencia:</strong> Av. del Puerto, 46023 Valencia. Teléfono: 901 11 99 99
                    </p>
                  </div>
                </div>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-blue-900 mb-2">Cómo inscribirse en Valencia</h3>
                    <p className="text-blue-800 leading-relaxed">
                      Puedes inscribirte online a través de la sede electrónica del SEPE o presencialmente en la oficina de Valencia. 
