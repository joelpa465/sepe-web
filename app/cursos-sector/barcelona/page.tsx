...
export const metadata: Metadata = {
  title: "Cursos SEPE Barcelona - Formación Profesional por Sector 2024",
  description: "Cursos gratuitos del SEPE en Barcelona por sector: informática, marketing, sanidad, idiomas y más. Formación profesional con certificación oficial en Cataluña.",
  keywords: ["cursos sepe barcelona", "cursos inem barcelona", "formación profesional barcelona", "cursos gratuitos barcelona", "cursos sepe cataluña"],
  alternates: {
    canonical: "/cursos-sector/barcelona",
  },
};
...
const sectores = [
  ...
  },
  {
    ...
    cantidad: "8 cursos disponibles"
  }
];

export default function CursosSectorBarcelonaPage() {
  return (
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-blue-100">
                Formación profesional gratuita por sector en Barcelona. Cursos especializados en tecnología, marketing, sanidad e idiomas con certificación oficial.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li className="text-gray-700">Barcelona</li>
              </ol>
            </nav>
          </div>
        </div>
              ...
              <div className="flex-1">
                <div className="max-w-4xl mx-auto mb-10">
                  <p className="text-lg text-gray-700 mb-6">
                    Barcelona ofrece una amplia variedad de cursos de formación profesional del SEPE organizados por sector. 
                  ...
                  <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg">
                    <p className="text-blue-800">
                      <strong>Oficina SEPE Barcelona:</strong> C/ Balmes, 115-117, 08008 Barcelona. Teléfono: 901 11 99 99
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {sectores.map((sector) => {
                    ...
                    return (
                      <Link key={sector.id} href={`/cursos-ccaa/barcelona`}>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded-r-lg">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-blue-900 mb-2">Cursos por sector en Barcelona</h3>
                    <p className="text-blue-800 leading-relaxed">
                      Los cursos del SEPE en Barcelona están organizados por sectores profesionales para facilitar la búsqueda. 
                      Puedes filtrar por sector de interés y encontrar el curso perfecto para tu desarrollo profesional. 
                      También puedes ver todos los cursos disponibles en Barcelona en nuestra sección de cursos por CCAA.
                    </p>
                  </div>
                </div>
              </div>
